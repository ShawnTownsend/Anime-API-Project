...
function narutoSelect() {
  document.body.style.backgroundImage = "url('images/backgrounds/rsz_naruto-background-pixteller.png')";
  previousBackground = "url('images/backgrounds/rsz_naruto-background-pixteller.png')";
